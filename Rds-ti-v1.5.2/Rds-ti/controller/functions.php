    ...
    echo "<div class='row'>
        ...
        <div class='card'>
            ...
            <div class='card-body'>
                <div>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='operador' name='novoSetor'>
                            <span class='form-check-label'>
                                Operador de caixa
                            </span>
                    </label>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='fiscal' name='novoSetor'>
                        <span class='form-check-label'>
                            Fiscal
                        </span>
                    </label>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='hortifruti' name='novoSetor'>
                        <span class='form-check-label'>
                            Hortifruti
                        </span>
                    </label>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='loja' name='novoSetor'>
                        <span class='form-check-label'>
                            Loja
                        </span>
                    </label>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='padaria' name='novoSetor'>
                        <span class='form-check-label'>
                            Padaria
                        </span>
                    </label>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='acougue' name='novoSetor'>
                        <span class='form-check-label'>
                            Açougue
                        </span>
                    </label>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='prevencao' name='novoSetor'>
                        <span class='form-check-label'>
                            Prevenção
                        </span>
                    </label>
                    ";
                        ...
                        echo "<label class='form-check'>
                            <input class='form-check-input' type='radio' value='gerente' name='novoSetor'>
                            <span class='form-check-label'>
                                Gerencia
                            </span>
                        </label>";
        ...
        <div class='card'>
            ...
            <div class='card-body'>
                <div>
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='Matriz' name='novaLoja'>
                            <span class='form-check-label'>
                                Matriz
                            </span>
                    </label>
                    ...
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='NSG' name='novaLoja'>
                        <span class='form-check-label'>
                            Filial NSG
                        </span>
                    </label>
                    ...
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='PA' name='novaLoja'>
                        <span class='form-check-label'>
                            Filial PA
                        </span>
                    </label>
                    ...
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='OH' name='novaLoja'>
                        <span class='form-check-label'>
                            Filial OH
                        </span>
                    </label>
                    ...
                    <label class='form-check'>
                        <input class='form-check-input' type='radio' value='PM' name='novaLoja'>
                        <span class='form-check-label'>
                            Filial PM
                        </span>
                    </label>
