    ...
    for ( $i = 0; $i < $dias; $i++) {
        ...
        for ($x = 0; $x < $colaboradores; $x++) {
            echo "<div class='col-12 col-lg-3'>".
                ...
                "<div class='card-body'>".
                "<div>".
                "<input type='text' class='form-control' required name='nome".$i."[]'>".
                "</div>".
                "</div>".
                "</div>".
                "</div>".
                ...
                "<div class='card-body'>" .
                "<div>" .
                "<input type='date' class='form-control' required name='folga".$i."[]'>".
                "</div>" .
                "</div>" .
                "</div>" .
                "</div>" ;
                ...
                <div class='card-body'>
                        <table class='table table-hover table-striped'>
                            ...
                            <tbody>";
                                ...
                                $consulta = $conexao->query("SELECT * FROM tb_solicitacao WHERE status = 'Solicitado!'"); 
                ...
                <div class='card-body'>
                    <form method='GET' action='#'>
                        <table class='table table-hover table-striped'>
                            ...
                            $nome = $_SESSION['nome'];
                            $consulta = $conexao->query("SELECT * FROM tb_solicitacao WHERE solicitante = '$nome' AND status = 'Solicitado!'"); 
                ...
                <div class='card-body'>
                        ...
                        <table class='table table-hover table-striped'>
                            ...
                            while ($row = $consulta->fetch()) {
                                ...
                                echo "<form method='GET' action='gera.doc.escala.php' target='_blank'>".
                                "<tr>".
                                "<th scope='row'>".$row['id'].
                                "</th><td>".$row['nome']."</td>".
...
function gerarListaEscalaRh(){
    $conexao = db_connect();
        ...
        <div class='col-12 col-lg-12'>
            <div class='card'>
                <div class='card-body'>
                    <form method='GET' action='gera.doc.escala.php' target='_blank'>
                        <table class='table table-hover table-striped'>
                            <thead>
                                <tr>
                                    <th scope='col'>Cod</th>
...
function gerar_lista_solicitacao(){
    $conexao=db_connect();
    if($_SESSION['nivel']==3){
        $consulta = $conexao->query("SELECT * FROM tb_solicitacao");
    }else{
        $nome = $_SESSION['nome'];
        $consulta = $conexao->query("SELECT * FROM tb_solicitacao WHERE solicitante = '$nome'");
    }
